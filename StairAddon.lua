...
local function CreateConfigFrame()
    ...
    printBtn:SetScript("OnEnter", function(self)
        ...
        GameTooltip:AddLine("Outputs each step's Z coordinate (height) and rotation angle.", nil, nil, nil, true)
        GameTooltip:AddLine(" ", nil, nil, nil, true)
        GameTooltip:AddLine("Step Height: The vertical distance (Z) that each step rises from the previous one.", nil, nil, nil, true)
        GameTooltip:Show()
    end)
